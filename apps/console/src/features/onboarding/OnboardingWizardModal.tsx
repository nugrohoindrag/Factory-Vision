              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-3)' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    borderRadius: 'var(--radius-lg, 12px)',
                    border: `2px solid ${experience === 'template' ? 'var(--color-primary)' : 'var(--color-outline-variant)'}`,
                ...
                <div
                  ...
                  style={{
                    padding: 'var(--space-4) var(--space-5)',
                    borderRadius: 'var(--radius-lg, 12px)',
                    border: `2px solid ${experience === 'blank' ? 'var(--color-primary)' : 'var(--color-outline-variant)'}`,
                ...
                <div
                  ...
                  style={{
                    padding: 'var(--space-4) var(--space-5)',
                    borderRadius: 'var(--radius-lg, 12px)',
                    border: `2px solid ${experience === 'demo' ? 'var(--color-primary)' : 'var(--color-outline-variant)'}`,
