...
export const HeroSection = ({ onOpenDemo, onOpenTrial }) => {
    return (_jsxs("section", { style: {
            ...
            overflow: 'hidden',
                                    ...
                                    gap: 'var(--space-4)',
                                    flexWrap: 'wrap',
                                }, children: [_jsxs("button", { onClick: onOpenTrial || onOpenDemo, className: "fv-btn-primary", style: { padding: `var(--space-4) var(--space-8)`, fontSize: '16px', gap: 'var(--space-2)' }, children: [_jsx(Icon, { name: "rocket_launch", size: 18 }), "Coba Gratis 14 Hari"] }), _jsxs("button", { onClick: onOpenDemo, className: "fv-btn-secondary", style: { padding: `var(--space-4) var(--space-8)`, fontSize: '16px', gap: 'var(--space-2)' }, children: [_jsx(Icon, { name: "calendar_today", size: 18 }), "Jadwalkan Demo"] }), _jsxs("a", { href: "#showcase", style: {
                                            display: 'inline-flex',
                                            alignItems: 'center',
                                            gap: 'var(--space-1)',
