...
export const QualityTraceabilitySection = () => {
    ...
    return (_jsxs("section", { className: "fv-section-py", style: { backgroundColor: '#001D39', color: '#FFFFFF' }, children: [_jsxs("div", { className: "fv-landing-container", children: [_jsxs("div", { style: { textAlign: 'center', maxWidth: '800px', margin: '0 auto 48px' }, children: [_jsxs("div", { className: "fv-eyebrow-on-blue", children: [_jsx(Icon, { name: "verified", size: 16 }), "Built-In Quality & Traceability"] }), _jsx("h2", { className: "fv-section-title-on-blue", children: "Quality Is Part of Production" }), _jsx("p", { className: "fv-section-desc-on-blue", style: { margin: '0 auto' }, children: "Never rely on disconnected paper checksheets. Factory Vision enforces quality checkpoints directly inside the operator workflow and preserves complete lot genealogy from raw coils to finished pallets." })] }), _jsxs("div", { className: "fv-card-on-blue", style: {
                            ...
                            gap: '36px',
                            alignItems: 'center',
                        }, children: [_jsxs("div", { style: { display: 'flex', flexDirection: 'column', gap: '24px' }, children: [_jsxs("div", { children: [_jsx("h3", { style: { fontSize: '26px', fontWeight: 800, color: '#001D39', marginBottom: '8px' }, children: "Complete Batch Genealogy Trace" }), _jsx("p", { style: { fontSize: '15px', color: '#334155', lineHeight: 1.55 }, children: "Track exactly which operator, machine, tool, and raw batch went into every serial number." })] }), _jsxs("div", { style: {
                                            ...
                                            gap: '16px',
                                        }, children: [_jsxs("div", { style: { display: 'flex', alignItems: 'center', justifyContent: 'space-between' }, children: [_jsxs("div", { children: [_jsx("span", { style: { fontSize: '11px', color: '#64748B', fontWeight: 700, textTransform: 'uppercase' }, children: "INSPECTED BATCH" }), _jsx("div", { style: { fontSize: '18px', fontWeight: 800, color: '#001D39' }, children: "#LOT-2026-0881 (Aluminium 6061-T6)" })] }), _jsx("span", { style: {
                                                            ...
                                                            fontSize: '12px',
                                                            fontWeight: 800,
                                                        }, children: "PASSED QC" })] }), _jsxs("div", { style: { display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '12px' }, children: [_jsxs("div", { style: { backgroundColor: '#FFFFFF', padding: '12px', borderRadius: '10px', border: '1px solid #E2E8F0' }, children: [_jsx("div", { style: { fontSize: '11px', color: '#64748B', fontWeight: 600 }, children: "Inspected" }), _jsx("div", { style: { fontSize: '16px', fontWeight: 800, color: '#001D39' }, children: "150 pcs" })] }), _jsxs("div", { style: { backgroundColor: '#FFFFFF', padding: '12px', borderRadius: '10px', border: '1px solid #E2E8F0' }, children: [_jsx("div", { style: { fontSize: '11px', color: '#64748B', fontWeight: 600 }, children: "Defect Rate" }), _jsx("div", { style: { fontSize: '16px', fontWeight: 800, color: '#059669' }, children: "0.00%" })] }), _jsxs("div", { style: { backgroundColor: '#FFFFFF', padding: '12px', borderRadius: '10px', border: '1px solid #E2E8F0' }, children: [_jsx("div", { style: { fontSize: '11px', color: '#64748B', fontWeight: 600 }, children: "Inspector" }), _jsx("div", { style: { fontSize: '16px', fontWeight: 800, color: '#0A4174' }, children: "QC Station 1" })] })] })] }), _jsx("div", { style: { display: 'flex', flexDirection: 'column', gap: '12px' }, children: steps.map((st, i) => (_jsxs("div", { style: { display: 'flex', alignItems: 'flex-start', gap: '12px' }, children: [_jsx("div", { style: {
                                                        width: '24px',
                                                        height: '24px',
                                                        borderRadius: '50%',
