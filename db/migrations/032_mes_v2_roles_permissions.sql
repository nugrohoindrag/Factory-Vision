...
BEGIN
  FOR grant_row IN
    SELECT * FROM (VALUES
      ...
      ('PRODUCTION_MANAGER', 'quality:ncr:create'),
      ('PRODUCTION_MANAGER', 'quality:ncr:manage'),
      ...
      ('QUALITY', 'quality:ncr:create'),
      ('QUALITY', 'quality:ncr:manage'),
...
CROSS JOIN (VALUES
  ...
  ('quality:disposition'), ('quality:ncr:create'), ('quality:ncr:manage'),
